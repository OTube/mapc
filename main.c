...
int main(int argc, char **argv){
    ...
    free(data);
    unsigned char *userdata = decode("/home/oleg/Desktop/gametex.ugg", USER_IMAGE_SIZE_INT, FILE_SIZE); //(unsigned char*)malloc(USER_IMAGE_SIZE_INT * USER_IMAGE_SIZE_INT * 4 * sizeof(unsigned char));
